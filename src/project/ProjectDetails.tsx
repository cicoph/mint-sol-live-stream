                        ...
                        <div className="w-full">
                            ...
                            { project.externalUrl.length > 0 &&
                                ...
                                { project.externalUrl.map( ( url, i ) => 
                                    url !== null && url !== '' && <li className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-500 hover:bg-blue-800 text-white mr-2"><a href={url} target="_blank" title=""><FontAwesomeIcon icon={ icons[i] } /></a></li>
                                )}
                            </ul> }
                        </div>
                    </div>
