    ...
    <div className="flex overflow-hidden">
      <div className="content">
        <div className="grid grid-cols-12 gap-0 mt-5 bg-white shadow rounded-md">
          <Grid size={`col-span-12 sm:col-span-12 md:col-span-5 lg:col-span-4 xl:col-span-4 p-6 h-screen max-h-screen overflow-y-scroll`}>
          ...
          <Grid size={`col-span-12 sm:col-span-12 md:col-span-2 lg:col-span-3 xl:col-span-3 p-6 h-screen max-h-screen overflow-y-scroll`}>
            <NftsList />
          </Grid>
        </div>
      </div>
